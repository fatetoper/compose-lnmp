...
router.get('/org/tree', (ctx) => {
  ctx.response.body = orgTree(ctx)
})
router.get('/role', (ctx) => {
  ctx.response.body = role(ctx)
})
router.get('/permission/no-pager', (ctx) => {
  ctx.response.body = permissionNoPager(ctx)
})
router.get('/permission', (ctx) => {
  ctx.response.body = permissions(ctx)
})
